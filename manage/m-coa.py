...
a: git clone && git clear package
b: backup beta.ROOT.war ~/tomcats/ROOT.war
c: replace tomcats[beta, quartz] ROOT.war
d: sh show.sh tomcat: beta
e: sh show.sh tomcat: quartz
